...
The `CodeAITux` class provides a terminal interface built with [Rich](https://github.com/Textualize/rich) and [prompt_toolkit](https://python-prompt-toolkit.readthedocs.io/).
