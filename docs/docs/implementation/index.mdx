...
The CLI automatically starts an codeai server as a background subprocess, waits for it to become healthy, then connects via the AG-UI protocol.
...
codeai --agent-id data-acquisition
