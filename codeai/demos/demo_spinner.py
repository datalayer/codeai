#!/usr/bin/env python3
"""
Demo script showing Code AI spinner in realistic scenarios.
...
from codeai.cli import Spinner, GREEN, CYAN, YELLOW, MAGENTA, RESET, BOLD
...
async def main():
    ...
    print(f"\n{MAGENTA}{BOLD}╔════════════════════════════════════════════════╗")
    print(f"║  Code AI Spinner - Realistic Usage Demo        ║")
    print(f"╚════════════════════════════════════════════════╝{RESET}\n")
    ...
    print(f"{YELLOW}Try it yourself: {RESET}{BOLD}codeai \"What is Python?\"{RESET}\n")
