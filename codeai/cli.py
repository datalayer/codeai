...
"""Code AI CLI Agent using Pydantic AI and ACP protocol support."""
...
app = typer.Typer(
    name="codeai",
    help="Code AI - AI-Powered Data Assistant",
...
def _show_version() -> None:
    ...
    typer.echo(f"{GREEN_LIGHT}Code AI{RESET} v{__version__.__version__}")
...
def main_callback(
    ...
    """Code AI - AI-Powered Data Assistant.
    ...
    try:
        if query:
            ...
            if agent_id:
                ...
                # Fall back to local agent
                agent.to_cli_sync(prog_name='codeai')
...
@app.command()
def version() -> None:
    """Show Code AI version information."""
    _show_version()
...
def main() -> None:
    """Main entry point for the Code AI CLI."""
    app()
